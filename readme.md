...
- [My Code: (My Code)](https://github.com/BAVI-BOOP/mysterious-organism-creater/blob/main/main.js)
...
mockUpStrand() is used to generate an array containing 15 bases to represent a single DNA strand with 15 bases.You’ll use these helper functions later to create your objects that represent P. aequor.
